  ...
  return (
    <main className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-[526px] bg-white p-8 rounded-lg shadow-md">
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="fr-py-5w space-y-6">
                ...
                <FormItem className="fr-fieldset__element">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex gap-2">
                          <Button
                            ...
                            aria-label={isPlaying ? "Mettre en pause la lecture" : "Lire le code du captcha"}
                          >
                            {isPlaying ? (
                  ...
                  <FormControl>
                    <Input 
                      {...field}
                      className="fr-input"
                      style={{ textTransform: captchaMode === "image" ? "uppercase" : "none" }}
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
            ...
            <div className="fr-btns-group">
              <Button type="submit" className="fr-btn w-full bg-[#000091] hover:bg-[#000074]">
                Créer mon compte
              </Button>
            </div>
          </form>
